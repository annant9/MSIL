...
const Header: React.FC = () => {
    ...
    <div className={styles.parentContainer}>
      <div className="o-header__top">
        ...
        <div className="o-header__quicklinks">
          <button type="button" className="a-button a-button--integrated">
            <i className="a-icon a-button__icon boschicon-bosch-ic-login"></i>
            <span className="a-button__label">Login</span>
          </button>
          <button type="button" className="a-button a-button--integrated">
            <i className="a-icon a-button__icon boschicon-bosch-ic-chat"></i>
            <span className="a-button__label">Contact</span>
          </button>
        </div>
      </div>
    </div>
  ...
  <div className={styles.parentContainer}>
    <div className='text-center'>
      <h4 className="o-header__subbrand">ECU Diagnostic Copilot</h4>
    </div>
  </div>
    ...
    <div className={styles.parentContainer}>
      <nav className="o-header__navigation" aria-label="Main navigation">
        <ul className="o-header__navigation-first-level" role="menu">
          <li className="o-header__language-selector" role="menuitem">
